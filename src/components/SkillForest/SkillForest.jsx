  ...
  return (
    <div className="w-full h-screen bg-gradient-to-b from-gray-900 to-black relative">
      <div className="absolute top-4 left-4 z-10 text-white pointer-events-none">
        <h1 className="text-3xl font-bold drop-shadow-md">Skill Forest</h1>
        <p className="text-gray-300 text-sm drop-shadow-md">Drag to rotate • Click a tree to explore</p>
      </div>
      
      {focusedSkill && (
        <button 
          onClick={handleReset}
          className="absolute top-4 right-4 z-20 px-6 py-2 bg-white/20 hover:bg-white/30 rounded-full text-white font-semibold backdrop-blur-md border border-white/30 transition-all shadow-lg"
        >
          ← Back to Forest
        </button>
      )}
